  ...
  return (
    <div className="flex flex-col items-start gap-2 rounded-[4px] border border-[rgba(224,229,235,0.6)] p-4">
      ...
      <button
        ...
        className="h-8 cursor-pointer rounded-xl border border-[#E0E5EB] bg-[#F7FBFD] px-3 text-[11px] font-semibold text-[#071123] shadow-[0px_1px_3px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)] transition-colors hover:bg-white disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:bg-[#F7FBFD]"
      >
