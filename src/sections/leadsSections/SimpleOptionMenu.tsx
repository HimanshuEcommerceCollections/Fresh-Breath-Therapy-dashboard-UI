...
// Generic floating option-list menu (a plain string list + checkmark on the
// selected one). Used anywhere that just needs a simple picker with no
// per-item management — e.g. DateRangeMenu. LocationSelectionMenu split off
// from this once the location filter needed add/delete management on top.
export default function SimpleOptionMenu({
  options,
  selected,
  onSelect,
  onClose,
