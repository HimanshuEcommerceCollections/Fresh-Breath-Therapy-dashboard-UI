...
const KEYWORDS: Record<string, string[]> = {
  ...
  "/payments": ["payment", "payments", "invoice", "invoices", "billing", "bill",
                "revenue", "paid", "unpaid", "partially paid", "pending payment",
                "overdue invoice", "balance", "collected", "installment", "instalment",
                "package price", "money", "transaction", "transactions", "ledger"],
  ...
  "/settings": ["setting", "settings", "config", "configuration", "package", "packages",
